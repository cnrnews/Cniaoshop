...
public class CNiaoToolBar extends Toolbar {
    ...
    public CNiaoToolBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            final Drawable rightIcon = a.getDrawable(R.styleable.CNiaoToolBar_rightButton);
            if (rightIcon != null) {
                //setNavigationIcon(navIcon);
                setRightButton(rightIcon);
            }
            boolean isShowSearchView = a.getBoolean(R.styleable.CNiaoToolBar_showSearchView, false);
            if (isShowSearchView) {
                showSearchView();
                hideTitleView();
            }
    ...
    public void setRightButton(int icon) {
        setRightButton(getResources().getDrawable(icon));
    }
